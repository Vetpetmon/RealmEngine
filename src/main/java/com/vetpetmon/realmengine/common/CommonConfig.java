...
public class CommonConfig {
    ...
    public static ModConfigSpec.IntValue noTieringZoneRadius, distancePerTier;
    public static ModConfigSpec.DoubleValue healthMultiplierPerTier, attackMultiplierPerTier, armorMultiplierPerTier, primarySkillMultiplierPerTier, secondarySkillMultiplierPerTier, logBase;
    ...
    public static ModConfigSpec.EnumValue<ScalingMode> scalingMode;
    public static ModConfigSpec.BooleanValue disableNetherPortal, disableEndPortal, tieringEnabled;
